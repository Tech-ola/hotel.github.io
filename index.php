...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li><i class="fa fa-phone" aria-hidden="true"></i>+234 (814)303-63-59</li>	
					<li class="s-bar">
						<div class="search">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
						   ...
						   <p class="about-para-w3ls">We are providing you all sorts of <b style="color: orange">luxuries</b> so even though you are far from home, you feel at home!</p>
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
                                       ...
                                       <div class="w3ls-info-about">
											...
											<p>They have been proven to be the best of its kind. </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
			 ...
			 <div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
			 	<div class="advantage-block ">
					<i class="fa fa-credit-card" aria-hidden="true"></i>
			 		...
			 		<p>We provide you the luxury of comfort first before making payments as it can even help clear your doubts about our services. We <b>provide:</b></p>
			 ...
			 <div class="col-md-6 advantage-grid right-w3ls wow zoomIn" data-wow-delay="0.3s">
			 	<div class="advantage-block">
					<i class="fa fa-clock-o" aria-hidden="true"></i>
			 		...
			 		<p>You may be far from home but with us; you will never be far from tasty dishes.</p>
					...
					<ul class="slides">
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>At first I had my doubts but after visitation, I realized its worth 5 stars. </p>
								<h5>Julia Rose</h5>
								<p>Germany</p>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>I got carried away with their top-notch services. You guys are truly the best! </p>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Lots of pleasures, fun and enjoyment. I have been to lots of hotels and I can tell you it's one of the best. </p>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>I would love to come again, this time not alone but with friends and family. </p>
								<h5>Amie Bublitz</h5>
								<p>Switzerland</p>
							</div>
							<div class="clearfix"> </div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+234 (814)303-63-59</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@SUNRISE.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> University Road, Ilorin, Nigeria</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2021 SUNRISE . All Rights Reserved | Design by <a href="index.php"><b>Olayinka</b></a> </p>
		    </div>
<!--/footer -->
<!-- js -->
